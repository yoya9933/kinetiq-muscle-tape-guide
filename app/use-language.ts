...
const en: Record<string, string> = {
  ...
  "你的導引流程":"Your guided flow","身體模型":"Body profile","不適關節":"Affected joint","不適位置":"Pain location","姿態校正":"Pose calibration","肌貼參數":"Tape plan","虛擬驗證":"Virtual preview","AR 導引":"AR guidance","貼後追蹤":"Follow-up",
